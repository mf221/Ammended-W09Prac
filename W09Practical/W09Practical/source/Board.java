public class Board {
    ...
    private static final char WHITE_KING   = 'W';
    ...
    public boolean isMoveLegal(String pos1, String pos2, char piece){
        ...
        if(isPieceThere(startColIndex, startRowIndex, piece) && isPieceThere(endColIndex,endRowIndex,FREE)
           && isMoveDiagonal(startColIndex, startRowIndex, endColIndex, endRowIndex)){
            return true;
        }
    ...
    public boolean isMoveDiagonal(int startColIndex, int startRowIndex, int endColIndex, int endRowIndex){
        if(startColIndex == 0){
        ...
        else if(endColIndex == startColIndex + 1 && endRowIndex == startRowIndex + 1 ||
           endColIndex == startColIndex - 1  && endRowIndex == startRowIndex + 1){
               return true;
           }
           else if(endColIndex == startColIndex + 1 && endRowIndex == startRowIndex - 1 ||
           endColIndex == startColIndex - 1  && endRowIndex == startRowIndex - 1 ){
    ...
    public boolean makeMove(String pos1, String pos2, char piece){
        ...
        if(isMoveLegal(pos1,pos2, piece) && isMoveDiagonal(startColIndex, startRowIndex, endColIndex, endRowIndex)){
